...
export default function CreateArtist({props}) {
    ...
    const form = useForm ({
            ...
            defaultValues: { 
                name: props.name, 
                spotifyLink: props.dspProfiles.spotify || "", 
                appleMusicLink: props.dspProfiles.appleMusic || "", 
                pro: props.pro || "", 
                ipi: props.ipi || "", 
                isni: props.isni || "" 
            }
    ...
    async function onSubmit(values) {
        try {
            ...
            const response = await fetch(`/api/artists/${props._id}/update`, options)
        ...
        redirect(`/catalog/artists/${props._id}`)
    }
return (
    <Form {...form}>
